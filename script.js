...
(function () {
    ...
    function initUI() {
        ...
        panel.id = 'rf-panel';
        panel.innerHTML = '<div class="rf-head"><h3>Trade Ads Filter</h3><button class="rf-x">×</button></div><div class="rf-body"><div class="rf-row"><span class="rf-lbl">Remove duplicates</span><label class="rf-sw"><input type="checkbox" id="rf-dupes"><span class="rf-sl"></span></label></div><div class="rf-row"><span class="rf-lbl">Block players</span><label class="rf-sw"><input type="checkbox" id="rf-players"><span class="rf-sl"></span></label></div><span class="rf-lbl2">Blocked User IDs</span><textarea class="rf-ta" id="rf-ids" placeholder="12345678 // Scammer"></textarea><div class="rf-hint">One ID per line. Comments after //</div><button class="rf-save">Save Settings</button><div class="rf-ok">Settings Saved!</div></div>';
        ...
        var okMsg = panel.querySelector('.rf-ok');
